...
file(MAKE_DIRECTORY ${PYTHON_PACKAGE_DST_DIR}/cplib)
...
file(COPY ${PYTHON_COMPILED_MODULE_PATH}
     DESTINATION ${PYTHON_PACKAGE_DST_DIR}/cplib)

# 3) Configured files and supporting files
configure_file("${PYTHON_PACKAGE_SRC_DIR}/setup.py"
               "${PYTHON_PACKAGE_DST_DIR}/setup.py")
configure_file("${PYTHON_PACKAGE_SRC_DIR}/cplib/__init__.py"
               "${PYTHON_PACKAGE_DST_DIR}/cplib/__init__.py")
