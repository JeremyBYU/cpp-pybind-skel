...
# Import cpplib raw python package with the highest priority
# This is a trick to show cpplib.cpplib as cpplib in the docs
...
man_pages = [(master_doc, 'cpplib', u'CPPLib Documentation', [author], 1)]
